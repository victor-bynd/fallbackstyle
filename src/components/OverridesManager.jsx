        ...
        <>
            {iconMode ? (
                <button
                    ...
                    className="relative w-8 h-8 flex items-center justify-center rounded-lg bg-slate-100/50 text-slate-400 hover:text-indigo-600 hover:bg-slate-200/50 transition-all active:scale-95 group shadow-sm border border-slate-200"
                >
