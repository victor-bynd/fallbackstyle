                ...
                <div className="relative">
                    {showSettings && (
                        <div className="absolute bottom-full left-0 mb-2 w-56 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 origin-bottom-left z-50">
                            ...
                            <div className="border-t border-gray-100 p-3 bg-slate-50/50 space-y-3">
                                <div className="px-1 text-[10px] font-bold text-slate-400 tracking-wider flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="w-full text-left px-3 py-2.5 text-xs font-bold text-rose-500 hover:text-rose-600 hover:bg-rose-50 border border-slate-200 hover:border-rose-200 bg-white rounded-xl flex items-center gap-2.5 transition-all shadow-sm"
                                >
