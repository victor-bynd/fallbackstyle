...
import PrimaryFontInput from '../components/BrandFont/PrimaryFontInput';
import FallbackSelector from '../components/BrandFont/FallbackSelector';
import BrandFontPreview from '../components/BrandFont/BrandFontPreview';
import BufferedInput from '../components/BufferedInput';
import { calculateOverrides, formatCSS } from '../utils/MetricCalculator';
...
const BrandFontFallback = () => {
    ...
    const handleFontLoaded = (fontData) => {
        ...
        // Extract metrics from opentype.js font object
        ...
        const newMetrics = { metrics, normalized };
        setPrimaryMetrics(newMetrics);
        console.log("Extracted Primary Metrics:", metrics);
